  ...
  const getCourseConfig = (title) => {
    ...
    if (titleLower.includes('основы') || titleLower.includes('вер')) {
      return {
        ...
        description: 'كيف يختلف الإسلام عن الأديان الأخرى. ما يؤمن به المسلمون.',
        hasLiterature: true,
      ...
      return {
        ...
        description: 'الطقوس اليومية الأساسية في حياة المسلم.',
        hasLiterature: true,
      ...
      return {
        ...
        description: 'علاقة الإنسان مع الخالق وروحه ومحيطه.',
        hasLiterature: false
      };
      ...
      return {
        ...
        description: 'دورة مميزة: دراسة متعمقة للثقافة والحضارة الإسلامية. 🔒 يتطلب رمز ترويجي.',
        hasLiterature: false,
        isPremium: true
      };
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">الدروس</h1>
                    ...
                    <div className="flex-1 min-w-0"> {/* min-w-0 prevents text overflow */}
                      ...
                      {config.hasLiterature && (
                        ...
                        >
                          ...
                          <span className="break-words">أدبيات إضافية</span>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {lessons.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">الدروس ستُضاف قريباً</h3>
            <p className="text-gray-500">هذه الدورة قيد التطوير</p>
          </div>
        )}
      </div>
    </div>
